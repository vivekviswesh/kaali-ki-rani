...
export default function App() {
  ...
  return (
    <div className="flex-col" style={{ minHeight: '100vh', justifyContent: 'space-between', background: '#020617' }}>
      ...
      {/* Root-Level Centered Round Verdict Overlay Modal */}
      {gameState && gameState.gameState === GAME_STATES.HAND_OVER && (() => {
        ...
        return (
          <div className="modal-overlay-blur" style={{ zIndex: 110 }}>
            <div className="modal-window-card animate-pop-in flex-col" style={{ padding: '1.5rem', maxWidth: '780px', width: '95%', gap: '1rem', textAlign: 'center', background: '#090d16', border: '1px solid rgba(255,255,255,0.08)' }}>
              ...
              <div style={{ borderTop: '1px solid rgba(255,255,255,0.08)', paddingTop: '1rem', marginTop: '0.25rem' }}>
                <button
                  onClick={() => handleAction('next_hand')}
                  className="btn btn-success"
      ...
      {/* Root-Level Centered Match Over Overlay Modal */}
      {gameState && gameState.gameState === GAME_STATES.MATCH_OVER && (() => {
        ...
        return (
          <div className="modal-overlay-blur" style={{ zIndex: 110 }}>
            <div className="modal-window-card animate-pop-in" style={{ padding: '2.5rem 2rem', border: '1px solid rgba(251, 191, 36, 0.3)', background: '#090d16' }}>
              <div style={{
                width: '4.5rem',
                height: '4.5rem',
